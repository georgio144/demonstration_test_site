...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".header-column-nav");
...
if(document.querySelectorAll('.main-slider__body')){
...
if (document.querySelectorAll('.slider-review__body')) {
   let slider_review = new Swiper('.slider-review__body', {
